...
exports.calculate = (advertisements,cart) => {
    ...
    advertisements.forEach((advertisement)=> {
        ...
        switch (advertisement.name){
            case "Standard Ad":
                totalPrice += this.calculateTotalAdsPrice(standardAd,originalPrice,userPromo);
                break
            case "Featured Ad":
                totalPrice += this.calculateTotalAdsPrice(featureAd,originalPrice,userPromo);
                break
            case "Premium Ad":
                totalPrice += this.calculateTotalAdsPrice(premiumAd,originalPrice,userPromo);
                break
            default:
